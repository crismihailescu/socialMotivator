...
function Activity(props) {
    ...
    <div>
        ...
        <div className={classes.sideWrapper}>
            ...
            <Enlist className={classes.sideBySize2} picture= {[props.activityImg]} name = {props.activityTitle} type = {props.activityType} location = {props.activityLocation} start = {props.start} duration = {props.duration}></Enlist>
        </div>
    </div>
    );
}
